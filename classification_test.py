...
tf.flags.DEFINE_string("neighbours", "./training_neighbours.txt", "Checkpoint directory from training run")
tf.flags.DEFINE_string("output_file", "./output.csv", "Csv file containing the results")
tf.flags.DEFINE_boolean("has_labels", True, "Decides whether the testing dataset has labels or not")
...
all_testing_embeddings = utils.load_embeddings(FLAGS.testing_embeddings_dir,
                                               FLAGS.embedding_dim)
# generate data
test_stories, test_true_endings, test_wrong_endings = utils.generate_data(all_testing_embeddings, FLAGS.neighbours)
